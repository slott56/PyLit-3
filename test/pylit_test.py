...
## which build test instances.  :py:func:`make_Text2Code_samples` and
## :py:func:`make_Code2Text_samples` are not simple tests; they create
...
## ====================
##
## This requires a different comment string.
